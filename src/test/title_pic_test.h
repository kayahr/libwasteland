...
#ifndef LIBWASTELAND_TITLE_PIC_TEST_H
#define LIBWASTELAND_TITLE_PIC_TEST_H
...
class title_pic_test: public CPPUNIT_NS::TestFixture
{
    CPPUNIT_TEST_SUITE(title_pic_test);
